...
const Menu = ({ toggleMenu, services, pricing, catalogue, about }) => {
  return (
    <div className=' fixed top-0 right-0 w-[50vw] h-screen bg-[#F2F5FF] z-30 flex flex-col items-right pr-[20px] justify-center shadow-sm'>
      <ul
